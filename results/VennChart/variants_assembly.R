...
data=read.table("corrected_variances/SNPs_all.csv", header=T,sep='\t')
PGM_snp=data[1,2]
...
data=read.table("corrected_variances/InDels_all.csv", header=T,sep='\t')
PGM_ind=data[1,2]
